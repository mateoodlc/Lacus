...
public class EstadisticasDetalle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ChartDataAdapter chartDataAdapter = new ChartDataAdapter(getActivity().getApplicationContext(), list);
    ...
    private class ChartDataAdapter extends ArrayAdapter<BarData> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                convertView = getLayoutInflater().from(getContext()).inflate(R.layout.detalle_list_item, null);
