...
public class OesteFragment extends Fragment{
...
//    private List<Order> dataset = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.oeste_fragment, container, false);
        recyclerView = (ParallaxRecyclerView) view.findViewById(R.id.oeste_my_recycler_view);
