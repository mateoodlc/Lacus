...
public class PanceFragment extends Fragment{
...
//    private List<Order> dataset = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pance_fragment, container, false);
        recyclerView = (ParallaxRecyclerView) view.findViewById(R.id.pance_my_recycler_view);
