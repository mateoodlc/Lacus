...
public class JamundiFragment extends Fragment{
...
//    private List<Order> dataset = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.jamundi_fragment, container, false);
        recyclerView = (ParallaxRecyclerView) view.findViewById(R.id.jamundi_my_recycler_view);
        ...
        temporalRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot veeduriaSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if(caso.getZona().equals("jamundi")) {
